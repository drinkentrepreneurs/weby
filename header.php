...
if ( $site_description && ( is_home() || is_front_page() ) )
    ...
    <a href="/">
    <!-- here is a default logo, you can use a custom -->
    <img src="/wp-content/themes/wedy/images/logo_aperoentrepreneurs_fin.png"  alt="logo" /> 
    </a> 
    </div> 
    ...
    <?php 
    $menu_name = 'primary';
    $args =  array( 'items_wrap'       => '<ul id="%1$s" class="%2$s">%3$s</ul>',
...
<?php /*
         <div id="city_search_bar_choices" style="display:none;"> 
       ...
       */ ?>
<input id="city_search_bar" name="address" placeholder="Paris, San Francison, Tashkent, ..." size="20" type="text">
